...
class HandDetection():
    ...
    def create_trackbars(self):
        ...
        cv2.createTrackbar('HueMax', 'Trackbars', 175, 179, empty)
        cv2.createTrackbar('SatMin', 'Trackbars', 58, 255, empty)
        cv2.createTrackbar('SatMax', 'Trackbars', 134, 255, empty)
        cv2.createTrackbar('ValMin', 'Trackbars', 67, 255, empty)
